...
config :task_manager, TaskManagerWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "IN9nyyQB9iLrpiB9qIFdiusGxO0xjacXXJdS5R+s8mGwKzkNfLFvK70C0V/lyymI",
  watchers: [
...
config :task_manager, TaskManagerWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/task_manager_web/router\.ex$",
      ~r"lib/task_manager_web/(controllers|live|components)/.*\.(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :task_manager, dev_routes: true, token_signing_secret: "Ft5FYc2TD8pGnDhVa9QtdZU4waCHHxA9"
