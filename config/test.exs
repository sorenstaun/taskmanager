import Config
config :task_manager, token_signing_secret: "JK0Oya43oFLIUd9Yn/Gqom8WTxfnkXBi"
...
config :task_manager, TaskManagerWeb.Endpoint,
  ...
  secret_key_base: "deByay4kyOzeUBKxhP7OwebR5Hei99KGFQiWHHDS+XAnF4mLCEtw5kFSvvLw2V5s",
  server: false
